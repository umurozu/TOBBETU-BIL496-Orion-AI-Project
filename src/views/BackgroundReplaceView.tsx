...
export const BackgroundReplaceView: React.FC = () => {
    ...
    const handleGenerate = async () => {
        if (!contentImage || !styleImage) {
            setError("Please upload both a subject foreground image and a background image first.");
            return;
        }
        ...
        try {
            ...
            formData.append('foreground_image', contentImage);
            formData.append('background_image', styleImage);
            ...
            const response = await fetch(`${API_BASE_URL}/background-replace`, {
                method: 'POST',
                headers,
                body: formData,
            });
        ...
        <div className="absolute inset-0 w-full h-full flex flex-col items-center justify-start py-8 px-4 md:px-8 overflow-y-auto custom-scrollbar">
                ...
                <div className="px-8 py-6 border-b border-slate-100 flex items-center justify-between bg-slate-50/50">
                    <div>
                        <h2 className="text-2xl font-bold text-slate-800 flex items-center gap-2">
                            <Sparkles className="w-6 h-6 text-purple-600" /> Background Replace
                        </h2>
                    </div>
            ...
            {isShareModalOpen && resultImage && (
                <DirectShareModal 
                    ...
                    aiOperation="Background Replace" 
